---
name: ground-truth
description: Evidence-based professional self-review. Reads your own git history, project files and AI session history to compare what you claim against what your artifacts actually show. Use when the user asks to review themselves, assess their skills honestly, prepare for a performance review or promotion panel, sanity-check their CV against reality, or asks "what am I good at" / "what should I improve".
---
